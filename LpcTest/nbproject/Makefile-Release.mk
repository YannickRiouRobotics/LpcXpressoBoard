...
${OBJECTDIR}/source/bluetooth.o: source/bluetooth.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/bluetooth.o source/bluetooth.c

${OBJECTDIR}/source/core_cm3.o: source/core_cm3.c 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/core_cm3.o source/core_cm3.c

${OBJECTDIR}/source/gps.o: source/gps.c 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gps.o source/gps.c
...
${OBJECTDIR}/source/uart.o: source/uart.c 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/uart.o source/uart.c
